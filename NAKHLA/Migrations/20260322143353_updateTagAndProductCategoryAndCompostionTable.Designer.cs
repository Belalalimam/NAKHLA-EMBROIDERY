...
namespace NAKHLA.Migrations
{
    ...
    [Migration("20260322143353_updateTagAndProductCategoryAndCompostionTable")]
    partial class updateTagAndProductCategoryAndCompostionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NAKHLA.Models.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NAKHLA.Models.Composition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NAKHLA.Models.FabricType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NAKHLA.Models.ProductComposition", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NAKHLA.Models.Product", b =>
                {
                    ...
                    b.HasOne("NAKHLA.Models.Color", "Color")
                        .WithMany("Products")
                        .HasForeignKey("ColorId");

                    b.HasOne("NAKHLA.Models.FabricType", "FabricType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("NAKHLA.Models.ProductComposition", b =>
                {
                    b.HasOne("NAKHLA.Models.Composition", "Composition")
                        .WithMany()
